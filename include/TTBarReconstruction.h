...
class LepTopReconstruction: public uhh2::AnalysisModule {
public:

    explicit LepTopReconstruction(uhh2::Context & ctx, const NeutrinoReconstructionMethod & neutrinofunction, const std::string & label="ZprimeTotTPrimeReconstruction");

    virtual bool process(uhh2::Event & event) override;

    virtual ~LepTopReconstruction();
