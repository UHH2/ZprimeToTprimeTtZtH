...
//Hist Btag50
  std::unique_ptr<Hists> eff_btag50_h;
  std::unique_ptr<Hists> jet_btag50_h;
  std::unique_ptr<Hists> muon_btag50_h;
  std::unique_ptr<Hists> event_btag50_h;
  std::unique_ptr<Hists> topjet_btag50_h;
 std::unique_ptr<Hists> chi2min_btag50_h;

std::unique_ptr<Hists> higgs_top_chi2min_btag50_h;
  std::unique_ptr<Hists> zw_top_chi2min_btag50_h;
  std::unique_ptr<Hists> higgs_notop_chi2min_btag50_h;
  std::unique_ptr<Hists> zw_notop_chi2min_btag50_h;
...
//Hists btag50
  topjet_btag50_h.reset(new TopJetHists(ctx, "topjet_btag50"));
  eff_btag50_h.reset(new ZPrimeTotTPrimeHists(ctx, "eff_btag50"));
  jet_btag50_h.reset(new JetHists(ctx, "jet_btag50"));
  muon_btag50_h.reset(new MuonHists(ctx, "muon_btag50"));
  event_btag50_h.reset(new EventHists(ctx, "event_btag50"));
 chi2min_btag50_h.reset(new ZPrimeTotTPrimeHypothesisHists(ctx, "chi2min_btag50",ZprimeTotTPrime_hyps_label,ZprimeTotTPrime_chi2_label ));

 higgs_top_chi2min_btag50_h.reset(new ZPrimeTotTPrimeHypothesisHists(ctx, "higgs_top_chi2min_btag50",ZprimeTotTPrime_hyps_label,ZprimeTotTPrime_chi2_label));
  higgs_notop_chi2min_btag50_h.reset(new ZPrimeTotTPrimeHypothesisHists(ctx, "higgs_notop_chi2min_btag50",ZprimeTotTPrime_hyps_label,ZprimeTotTPrime_chi2_label));
  zw_top_chi2min_btag50_h.reset(new ZPrimeTotTPrimeHypothesisHists(ctx, "zw_top_chi2min_btag50",ZprimeTotTPrime_hyps_label,ZprimeTotTPrime_chi2_label));
  zw_notop_chi2min_btag50_h.reset(new ZPrimeTotTPrimeHypothesisHists(ctx, "zw_notop_chi2min_btag50",ZprimeTotTPrime_hyps_label,ZprimeTotTPrime_chi2_label));
